      ...
      <header className="fixed top-0 z-50 w-full backdrop-blur-md bg-background/60 border-b border-border">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/book" className="rounded-full border border-primary/40 px-5 py-2 text-sm text-primary hover:bg-primary hover:text-primary-foreground transition">Book</Link>
          </div>
        </div>
      </header>
      ...
      <main>
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center animate-fade-in">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link to="/book" className="rounded-full bg-primary px-8 py-3.5 text-sm font-medium text-primary-foreground hover:bg-gold transition shadow-[0_0_40px_-10px_var(--gold)]">Reserve Your Ritual</Link>
            <a href="#services" className="rounded-full border border-border px-8 py-3.5 text-sm text-foreground hover:border-primary transition">Explore Services</a>
          </div>
        </div>
              ...
              <article key={s.name} className="group relative overflow-hidden rounded-lg bg-card border border-border">
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center justify-between border-t border-border pt-4">
                    ...
                    <Link to="/book" className="text-xs uppercase tracking-widest text-primary hover:text-gold transition">Reserve →</Link>
                  </div>
                </div>
              </article>
            ))}
      ...
      <section className="relative py-32 bg-radial-glow">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light leading-tight">
            Experience genuine wellness therapies in Jaipur with trusted, verified professionals.
          </h2>
      ...
      <section id="book" className="relative py-32 border-t border-border">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            <a href={whatsappLink} target="_blank" rel="noreferrer" className="inline-block rounded-full bg-primary px-10 py-4 text-sm font-medium text-primary-foreground hover:bg-gold transition shadow-[0_0_60px_-10px_var(--gold)]">Contact us on WhatsApp</a>
          </div>
        </div>
      </section>
      </main>
