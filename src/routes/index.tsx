...
const stonesImg = "https://images.unsplash.com/photo-1600334129128-68505bce6a5f?q=80&w=800&auto=format&fit=crop";
...
function Landing() {
  const [telegramLink, setTelegramLink] = useState("https://t.me/SHREYA_PATIDAR");
